...
public class menuGeneral extends menus{
	...
	private void afficheChoixSession() {
		...
		System.out.println("4.Se connecter en tant que Technicien");
		System.out.println("5.Se connecter en tant que Client");
	...
	private void executeActionConnexion(int choixSession) {
		...
		case 3:
			...
			break;
		case 4:
			menuTechnicien menuTech =new menuTechnicien(pseudo,mdp);
			if(menuTechnicien.getTech()!= null) {						
				menuTech.executeMenu();
				}													
			break;
		case 5:
